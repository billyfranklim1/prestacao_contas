...
(function(window, document, $) {
    ...
    $(document).on('click', '.menu-toggle', function(e) {
        ...
        var redeSocialLeft = $('#rede-social-left');

        if(redeSocialLeft.hasClass('margin-left-30-px')){
            redeSocialLeft.removeClass('margin-left-30-px');
        }else {
            redeSocialLeft.addClass('margin-left-30-px');
        }
        return false;
    });
